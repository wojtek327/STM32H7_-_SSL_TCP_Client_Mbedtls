...
static int ssl_write_client_hello( mbedtls_ssl_context *ssl )
{
    ...
    MBEDTLS_SSL_DEBUG_MSG( 3, ( "=> write client hello3" ) );

    MBEDTLS_SSL_DEBUG_MSG( 4, ( "=> write client hello4" ) );

    MBEDTLS_SSL_DEBUG_MSG( 5, ( "=> write client hello5" ) );
...
int mbedtls_ssl_handshake_client_step( mbedtls_ssl_context *ssl )
{
    ...
    mbedtls_printf("mbedtls_ssl_handshake_client_step");
